 ...
 * ........................................................................ */
   ...
   /* ... Include / Inclusion ........................................... */
      ...
      #include "wcopy/l_wcpdl.h"


   /* ... Functions / Funciones ......................................... */
  
      T_BOOL  L_WCPDL_DownLoadStart   ( IN    t_wppOptions  *wOpt )
      {
        T_CHAR         *fname ;
        t_url           url ;
        T_BOOL          ok ;
        ...
        setbuf(flog,NULL) ;
        ok    = L_LOG_Setup(flog,c_WCOPY_VER) ;
        if (ok == FALSE)
           {
             fclose(flog) ;
             fclose(fres) ;
        ...
        ok    = L_DLBOT_DownLoadWeb(&dlws,&url) ;
        L_URL_Empty(&url) ;
        fclose(flog) ;
        fclose(fres) ;
        return ok ;
      ...
      T_BOOL  L_WCPDL_DownLoadRecover    ( IN    t_wppOptions  *wOpt )
      {
        T_CHAR         *fname ;
        T_CHAR         *bname ;
        T_BOOL          ok ;
        ...
        /* ... go recover ... */
        ok = L_DLBOT_DownLoadRecover(&dlws) ;
        fclose(flog) ;
        fclose(fres) ;
        return ok ;
      }
      ...
      T_BOOL  L_WCPDL_DownLoad    ( IN   t_wppOptions    *wOpt )
      {
        ...
        if ( (wOpt->href == NULL) && (wOpt->recoverFile != NULL) )
              ok = L_WCPDL_DownLoadRecover(wOpt) ;
        if ( (wOpt->href != NULL) && (wOpt->recoverFile == NULL) )
              ok = L_WCPDL_DownLoadStart(wOpt) ;
        return ok ;
      }
